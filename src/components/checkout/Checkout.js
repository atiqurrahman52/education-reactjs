  ...
  return (
    <div className="container">
      <div className="py-6 xl:py-16 max-w-[1076px]">
        ...
        {/* <div className="grid grid-cols-5 gap-6 justify-between pt-2.5">
          ...
          <div className="col-span-3 md:col-span-1">
            <p className="font-poppins font-medium text-xs xl:text-base leading-[18px] xl:leading-6 text-disable mb-3">
              Discount
            </p>
            <p className="font-poppins font-medium text-sm xl:text-lg leading-[21px] xl:leading-[27px] text-primary mb-4">
              24$
            </p>
          </div>
        ...
        <div className="flex justify-end items-center gap-3 xl:gap-6">
          <Link
            to="/course-details"
            className="font-poppins text-sm xl:text-base leading-[21px] xl:leading-6 text-disable py-[8px] xl:py-2.5 px-4 xl:px-9 bg-[#F1F1F2] rounded block"
          >
            Back to Courses
          </Link>
          <Link
            to="#"
            className="font-poppins font-medium xl:font-semibold text-sm xl:text-base text-white leading-[21px] xl:leading-6 bg-success py-[8px] xl:py-2.5 px-[28px] xl:px-[56px] rounded"
          >
            Checkout
          </Link>
        </div> */}

...
const SignIn = () => {
    return (
        ...
        <div
          class="w-full flex items-center justify-center my-10 lg:my-20"
        >
          <div
          ...
          >
            ...
            <div
              class="flex justify-end font-poppins text-sm leading-[22px] pt-5 md:pt-3 text-primary"
            >
            ...
            <div class="flex justify-center items-center py-5 xl:py-6">
              <span
                ...
                <a href="../pages/signup.html" class="text-success"> Join us</a>
              </span>
            </div>
          </div>
        </div>

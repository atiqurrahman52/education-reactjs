import { Alarm, BookOpen, FileText, LockKey } from "phosphor-react";
...
const CoursesVideo = () => {
  ...
  return (
    <>
      <div className="h-[725px] overflow-y-auto scrollbar-main mt-8">
        <div className="flex justify-between mb-4">
          <div>
            <h3 className="font-poppins font-semibold text-sm xl:text-lg leading-5 xl:leading-9 text-primary">
              Course content
            </h3>
          </div>
          <div className="flex space-x-2 xl:space-x-12">
            <div className="flex items-center space-x-1 xl:space-x-3">
              <Alarm size={20} className="text-success" />
                    ...
                    <div className="accordion-content ">
                      <div className="space-y-4 pt-4">
                        <div className="flex justify-between py-2 px-4">
                          ...
                          <div className="flex space-x-2 xl:space-x-4">
                            <button
                              className="preview-btn font-poppins font-medium text-xs xl:text-sm text-success leading-[18px] xl:leading-[21px]"

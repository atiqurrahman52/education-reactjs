    ...
    <div className="col-span-4">
      <div class="relative preview-btn cursor-pointer">
        ...
        <div class="absolute inset-0 flex items-center justify-center">
          ...
          <p class="absolute left-1/2 -translate-x-1/2 bottom-3 text-white font-poppins font-semibold text-sm xl:text-base">
            Review this course
          </p>
        </div>
      </div>
      ...
      <div class="pt-6">
        <button class="bg-success text-white font-poppins font-medium text-lg leading-7 rounded-lg w-full h-[56px] lg:max-w-[365px]">
          <a class="#" href="">
            Get this course
          </a>
        </button>
